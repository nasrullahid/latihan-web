# 1. Harga barang 120000. Diskon 25%. Hitung dan cetak harga setelah diskon.

# 2. Nilai (0–100). cetak grade: A (≥85), B (70–84), C (55–69), D(<55)

# 3. Hitung total penjumlahan dari 1 + 2 + 3 + ... + 100. Cetak hasilnya.

# 4. Cetak pola berikut menggunakan perulangan bersarang (nested loop):
```sh
*
**
***
